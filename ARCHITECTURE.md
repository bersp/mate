...
- `find_overflows(layout)` — the regions whose arranged content is larger than the region, with the excess in cm. Reads the boxes the arrange pass measured, with no query of its own.
